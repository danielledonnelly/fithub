...
CREATE TABLE `steps` (
  ...
  `inputted_steps` int NOT NULL DEFAULT '0',
  `fitbit_steps` int NOT NULL DEFAULT '0',
...
CREATE TABLE `users` (
  ...
  `fitbit_auto_sync_enabled` tinyint(1) DEFAULT '1',
  `fitbit_auto_sync_completed` tinyint(1) DEFAULT '0',
  `fitbit_auto_sync_last_attempt` timestamp NULL DEFAULT NULL,
  `fitbit_auto_sync_next_attempt` timestamp NULL DEFAULT NULL,
  `fitbit_auto_sync_failed_count` int DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `username` (`username`),
  UNIQUE KEY `email` (`email`),
  KEY `idx_users_fitbit_connected` (`fitbit_connected`),
  KEY `idx_users_auto_sync` (`fitbit_auto_sync_enabled`,`fitbit_auto_sync_next_attempt`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
