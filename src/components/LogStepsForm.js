      ...
      <div className="flex flex-row gap-2">
        <div className="flex flex-col gap-0.5 flex-1">
          ...
          <input
            ...
            required
            className="px-3 py-2 text-sm font-sans bg-fithub-dark-grey border border-solid border-fithub-light-grey rounded-md text-fithub-text w-full outline-none focus:outline-none focus:ring-0 focus:border-fithub-salmon transition-colors"
          />
        </div>
        ...
        <div className="flex flex-col gap-0.5 flex-1">
          ...
          <input
            ...
            min="0"
            required
            className="px-3 py-2 text-sm bg-fithub-dark-grey border border-solid border-fithub-light-grey rounded-md text-fithub-text w-full outline-none focus:outline-none focus:ring-0 focus:border-fithub-salmon transition-colors [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
          />
        </div>
      </div>
